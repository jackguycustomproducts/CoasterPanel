...
//outputs pins
#define RESET_LT 12
#define DISPATCH_LT A5
#define A_LT A4 //toggle 2
#define B_LT A3 //toggle 3
#define C_LT A2 //toggle 4
#define ESTOP_LT A1 //toggle 1
#define KEY_LT A0 //toggle 0
...
void loop()
{
  ...
  ProcessSwitch(A_SW, A_On, A_Off, prev[7]);
